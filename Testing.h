/*============================================================================
  ...
  Copyright (C) 2019 by Zack T Smith. (original author)
...
#define DECLARE_TESTING_METHODS(TYPE_POINTER) \
	long (*read) (TYPE_POINTER, long *results, unsigned long size, TestingMode mode, bool random, bool first_touch); \
	long (*write) (TYPE_POINTER, long *results, unsigned long size, TestingMode mode, bool random, bool first_touch); \
	long (*copy) (TYPE_POINTER, long *results, unsigned long size, TestingMode mode, bool first_touch); \
	...
	int (*calculate_result) (TYPE_POINTER, unsigned long chunk_size, long long total_loops, uint64_t diff, bool print);
